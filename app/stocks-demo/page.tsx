    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100">
      ...
      <div className="border-b border-gray-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900">Aksjer - FASE 3-6 Demo</h1>
      ...
      <div className="bg-purple-100 border-b border-purple-200 px-4 py-2">
        <div className="mx-auto max-w-7xl">
          <p className="text-sm text-purple-800">
            ✅ FASE 3-6 Completed: Norwegian Chart + Holdings Table + Loading States + Page Integration
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="space-y-6 lg:col-span-3">
            ...
            <StockChartWidget
              ...
              onTimeRangeChange={(range) => console.log('Chart time range:', range)}
            />

            {/* Norwegian Holdings Table with Sample Data */}
            <NorwegianHoldingsTable
              onHoldingClick={(holding) => console.log('Clicked holding:', holding)}
              onTimeRangeChange={(range) => console.log('Table time range:', range)}
            />
          </div>
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              <h4 className="font-medium text-green-900 mb-2">Komponenter Status:</h4>
              <div className="space-y-1 text-sm text-green-800">
                <div>✅ StockChartWidget - Purple theme, norsk format</div>
                <div>✅ NorwegianHoldingsTable - EQUINOR, DNB data</div>
                <div>✅ LoadingStates - Framer Motion animations</div>
                <div>✅ NorwegianBreadcrumb - Auto-detection</div>
              </div>
            </div>
          </div>
        </div>
