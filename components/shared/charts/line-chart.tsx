      ...
      return (
        ...
        >
          <div className="p-4">
            {title && (
              <div className="mb-4">
                <div className="mb-2 h-6 w-1/3 animate-pulse rounded bg-neutral-200 dark:bg-neutral-700" />
                {description && (
                  <div className="h-4 w-1/2 animate-pulse rounded bg-neutral-200 dark:bg-neutral-700" />
                )}
              </div>
            )}
            <div className="flex h-full animate-pulse items-center justify-center rounded bg-neutral-100 dark:bg-neutral-800">
