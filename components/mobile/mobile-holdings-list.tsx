...
const SwipeActions = memo(({ onEdit, onDelete, isVisible }: SwipeActionsProps) => (
  <div className={cn(
    ...
    <Button
      ...
      size="sm"
      onClick={onEdit}
      className="h-full px-4 bg-blue-500 text-white hover:bg-blue-600 rounded-none"
    >
    ...
    <Button
      ...
      size="sm"
      onClick={onDelete}
      className="h-full px-4 bg-red-500 text-white hover:bg-red-600 rounded-none rounded-r-lg"
    >
...
const HoldingCard = memo(({ holding, onEdit, onDelete, index }: HoldingCardProps) => {
  ...
  return (
    <div className="relative overflow-hidden">
      <Card
        ref={cardRef}
        className={cn(
          'relative transition-transform duration-200 cursor-pointer touch-none',
        ...
        {holdings.length === 0 ? (
          <Card className="p-8 text-center">
            <div className="text-gray-500">
              <div className="text-lg font-medium mb-2">No holdings found</div>
              <div className="text-sm">Start by adding your first stock position</div>
            </div>
          </Card>
        ) : (
