  ...
  return (
    ...
    >
      ...
      <div
        ref={sheetRef}
        className={cn(
          'relative w-full max-w-md bg-white rounded-t-2xl shadow-xl transition-transform duration-300',
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50" onClick={handleClose}>
          <div
            className={cn(
              'absolute bg-white rounded-xl shadow-lg border border-gray-200 py-2 min-w-48',
...
export const useActionSheet = () => {
  ...
  const showActionSheet = useCallback((newConfig: {
    title?: string;
    subtitle?: string;
    items: ActionSheetItem[];
  }) => {
