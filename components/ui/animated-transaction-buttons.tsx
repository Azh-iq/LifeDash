  ...
  return (
    <div className={cn("flex gap-3 w-full", className)}>
      ...
      <button
        ...
        className={cn(
          // Base styles
          "group relative flex-1 px-6 py-4 rounded-xl font-semibold text-sm transition-all duration-300 transform-gpu",
          ...
          value === 'BUY'
            ? [
                ...
                "hover:shadow-xl hover:shadow-green-500/60 hover:scale-105",
                "focus:ring-green-500",
              ]
            : [
                // Inactive state - subtle with hover effects
                "bg-white/50 backdrop-blur-sm border-2 border-green-200/50",
                "text-green-700 hover:text-green-800",
                "hover:bg-green-50/80 hover:border-green-300/70",
      ...
      >
        ...
        <div 
          className={cn(
            ...
            "transform -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] group-hover:opacity-100"
          )}
        />
      </button>
        ...
        className={cn(
          ...
          value === 'SELL'
            ? [
                ...
                "hover:shadow-xl hover:shadow-red-500/60 hover:scale-105",
                "focus:ring-red-500",
              ]
            : [
                // Inactive state - subtle with hover effects
                "bg-white/50 backdrop-blur-sm border-2 border-red-200/50",
                "text-red-700 hover:text-red-800",
                "hover:bg-red-50/80 hover:border-red-300/70",
                "hover:shadow-md hover:scale-102",
                "focus:ring-red-300",
              ],
        ...
        className={cn(
          ...
          value === 'BUY'
            ? [
                ...
                "hover:shadow-xl hover:shadow-orange-500/60 hover:scale-105",
                "focus:ring-orange-500",
              ]
            : [
                // Inactive state - dark with orange accents
                "bg-gray-800/50 backdrop-blur-sm border-2 border-orange-200/30",
                "text-orange-300 hover:text-orange-200",
                "hover:bg-gray-700/60 hover:border-orange-300/50",
                "hover:shadow-md hover:scale-102",
        ...
        className={cn(
          ...
          value === 'SELL'
            ? [
                ...
                "hover:shadow-xl hover:shadow-red-600/60 hover:scale-105",
                "focus:ring-red-500",
              ]
            : [
                // Inactive state - dark with red accents
                "bg-gray-800/50 backdrop-blur-sm border-2 border-red-200/30",
                "text-red-300 hover:text-red-200",
                "hover:bg-gray-700/60 hover:border-red-300/50",
                "hover:shadow-md hover:scale-102",
                "focus:ring-red-400",
              ],
