...
export function ErrorPortfolioState({
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-red-50 to-pink-50 ${className}`}>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-left">
                      <p className="text-sm text-gray-800 font-medium">Feilmelding:</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 text-left">
                    <h4 className="font-semibold text-blue-900">Trenger du hjelp?</h4>
                    <p className="text-sm text-blue-700 mb-3">
                      {type === 'network' && 'Sjekk internettforbindelsen din og prøv igjen. Hvis problemet vedvarer, kan det være midlertidig nedetid.'}
                      {type === 'auth' && 'Logg inn på nytt for å få tilgang til porteføljedataene dine.'}
                      {type === 'data' && 'Dette kan skyldes problemer med datakildene våre. Prøv igjen om litt.'}
                      {type === 'server' && 'Vi jobber med å løse problemet. Prøv igjen om noen minutter.'}
                      {type === 'unknown' && 'Hvis problemet vedvarer, kan du kontakte support for hjelp.'}
                    </p>
                    {showContactSupport && (
                      <Button
          ...
          {process.env.NODE_ENV === 'development' && (
            <motion.div variants={entranceVariants.item} className="mt-8">
              <Card className="bg-gray-100 border-gray-300">
                <CardContent className="p-4">
                  <div className="text-left">
                    <h4 className="font-semibold text-gray-900 mb-2">Utviklerinfo:</h4>
