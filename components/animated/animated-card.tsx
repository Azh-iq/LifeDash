...
export const AnimatedCard = forwardRef<HTMLDivElement, AnimatedCardProps>(({
  ...
  const defaultMotionProps: MotionProps = {
    ...
    variants: finalAnimation !== 'none' ? entranceVariants[finalAnimation] : undefined,
    transition: finalAnimation !== 'none' ? {
      ...entranceVariants[finalAnimation]?.visible?.transition,
      delay: animationDelay
    } : undefined,
    whileHover: hover && !reducedMotion ? createHoverVariant(hoverScale, hoverY) : undefined,
  ...
  const cardClasses = cn(
    ...
    cardDepthStyles[depth],
    {
      ...
      'dark:from-gray-900 dark:via-gray-900 dark:to-blue-900/20': gradient && !glow,
 ...
 */
export const PortfolioCard = forwardRef<HTMLDivElement, AnimatedCardProps & {
...
export const MetricCard = forwardRef<HTMLDivElement, AnimatedCardProps & {
  ...
  return (
    <AnimatedCard
      ...
      className={cn(
        {
          'ring-2 ring-blue-500/20 bg-blue-50/50': highlight,
          'ring-2 ring-red-500/20 bg-red-50/50': urgent,
    ...
    >
      ...
      {urgent && (
        <motion.div
          className="absolute inset-0 ring-2 ring-red-400/50 rounded-lg"
          animate={{
            scale: [1, 1.02, 1],
            opacity: [0.5, 0.8, 0.5]
          }}
  ...
  return (
    <AnimatedCard
      ...
      className={cn(
        ...
        {
          'ring-2 ring-blue-500 bg-blue-50/50 dark:bg-blue-900/20': selected,
