          ...
          <div className="space-y-3">
            <label className="flex cursor-pointer items-start gap-3">
              <input
                ...
                type="checkbox"
                className="mt-0.5 h-4 w-4 rounded border-neutral-300 bg-neutral-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-neutral-600 dark:bg-neutral-700 dark:ring-offset-neutral-800 dark:focus:ring-primary-600"
                disabled={isLoading}
              />
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              />
              <span className="text-sm text-neutral-600 dark:text-neutral-400">
                I&apos;d like to receive product updates, tips, and promotional
                emails (optional)
              </span>
            </label>
          </div>
