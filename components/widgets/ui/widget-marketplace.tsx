...
import { Search, Filter, Grid, List, X, Plus, Eye, Settings, Info } from 'lucide-react'
import { 
  Dialog,
  DialogContent,
  DialogHeader,
      ...
      <CardContent className="py-4">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500">
            ...
            <span>
              {registration.performance.memoryUsage} minne
            </span>
          </div>
        </div>
      </CardContent>
...
export const WidgetMarketplace: React.FC<WidgetMarketplaceProps> = ({
  ...
  const availableSizes: Array<WidgetSize | 'ALL'> = ['ALL', 'SMALL', 'MEDIUM', 'LARGE', 'HERO']
          ...
          <div className="p-6 pb-4 border-b bg-gray-50">
            <div className="flex flex-col gap-4">
              ...
              <div className="text-sm text-gray-600">
                {searchResults.length} widget{searchResults.length !== 1 ? 's' : ''} funnet
              </div>
            </div>
          </div>
                  ...
                  <div className={cn(
                    ...
                    {searchResults.map((result) => (
                      <WidgetPreviewCard
                        ...
                        onPreview={() => handlePreviewWidget(result.registration)}
                        onConfigure={() => handleConfigureWidget(result.registration)}
                        loading={loading}
                      />
                    ))}
                  </div>
