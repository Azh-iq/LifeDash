...
export function MobileWidgetContainer({
  ...
  const MobileHeader = () => (
    <CardHeader
      className={cn('pb-3', theme.accent, 'border-b border-gray-200')}
    >
    ...
    >
      ...
      <div className="flex h-full items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-2 text-sm text-gray-600">{widget.type}</p>
  ...
  return (
    ...
    >
      ...
      {isSwipeEnabled && (
        <motion.div
          className="absolute inset-0 flex items-center justify-center rounded-lg bg-red-500 text-white opacity-0"
          animate={{
